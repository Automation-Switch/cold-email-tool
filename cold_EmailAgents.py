...
class ColdEmailAgents:
    ...
    def pain_points_analyst(self):
        return Agent(
            ...
            backstory="""You are a Business Pain Points Analyst who identifies the key pain points of job titles provided by the Business Portfolio Analyst,
                    You Rank the key pain points in order of the intensity of their impact on revenue by always submit your findings in a three column table.. 
    ...
    def cold_email_generator(self):
        return Agent(
            ...
            backstory="""You are a world class marketer in the mould of Russel Brunson. who takes into account the information and details provided by the Business Analyst, the Business Portfolio Analyst,
